...
namespace Debut
{
	...
	{
		None = 0, Mesh, Material, Texture2D, Skybox, Shader, PhysicsMaterial2D, PhysicsMaterial3D, Model, 
		PostProcessingStack, ScriptMetadata
	};
	...
	private:
		...
		void DrawScriptMetadataProperties();
