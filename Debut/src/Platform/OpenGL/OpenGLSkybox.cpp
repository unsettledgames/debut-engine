...
namespace Debut
{
		...
		const std::string& right, const std::string& up, const std::string& down)
	{
        ...
        std::vector<GLuint> faces = { GL_TEXTURE_CUBE_MAP_POSITIVE_Z, GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, GL_TEXTURE_CUBE_MAP_NEGATIVE_X,
    ...
    {
        SkyboxConfig config = GetConfig(m_Path);
        m_Textures = config.Textures;
        ...
        std::vector<std::string> facesPaths = { AssetManager::GetPath(config.Textures[SkyboxTexture::Front]), 
            AssetManager::GetPath(config.Textures[SkyboxTexture::Bottom]),
            AssetManager::GetPath(config.Textures[SkyboxTexture::Left]),
            AssetManager::GetPath(config.Textures[SkyboxTexture::Right]),
            AssetManager::GetPath(config.Textures[SkyboxTexture::Up]),
